...
<section class="page-section" id="services">
    <div class="container">
        <div class="text-center">
            <h2 class="section-heading text-uppercase" id="rearange">Services</h2>
        ...
        <div class="row text-center" id="postdata"></div>
    </div>
</section>
<!-- Portfolio Grid-->
...
<section class="page-section" id="about">
    <div class="container">
        ...
        <ul class="timeline">
            ...
            <li>
                <div class="timeline-image"><img class="rounded-circle img-fluid" src="{{URL::to('/')}}/application/public/temp1/assets/img/about/3.jpg" alt="..." /></div>
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <h4>December 2015</h4>
            ...
            <li class="timeline-inverted">
                <div class="timeline-image"><img class="rounded-circle img-fluid" src="{{URL::to('/')}}/application/public/temp1/assets/img/about/4.jpg" alt="..." /></div>
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <h4>July 2020</h4>
...
<section class="page-section bg-light" id="team">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="team-member">
                    <img class="mx-auto rounded-circle" src="{{URL::to('/')}}/application/public/temp1/assets/img/team/3.jpg" alt="..." />
                    <h4>Larry Parker</h4>
