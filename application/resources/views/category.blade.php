...
<section class="page-section bg-light" id="portfolio">
    <div class="container">
        <div class="text-center">
            <h2 class="section-heading text-uppercase">All Products of {{$catename}}</h2>
            <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
        </div>
        <div class="row">
            @foreach($productbycatid as $item)
            <div class="col-lg-4 col-sm-6 mb-4">
                ...
                <div class="portfolio-item">
                    <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                        ...
                        <img class="img-fluid" src="{{URL::to('/')}}/application/storage/app/products/{{$item->picture}}" alt="..." />
                    </a>
                    <div class="portfolio-caption">
                        <div class="portfolio-caption-heading">{{$item->name}}</div>
                        <div class="portfolio-caption-subheading text-muted">{{$item->summary}}</div>
                        <form action="{{URL::to('/')}}/addtocart/{{$item->id}}" method="post">@csrf
